    ...
    >
      <div className="flex items-center justify-between w-full mx-auto max-w-7xl">
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Ashish Khopde &nbsp; 
        ...
        <ul className="flex-row hidden gap-10 list-none sm:flex">
          {navLinks.map((link) => (
            <li
              key={link.id}
              className={`${active === link.title ? 'text-white' : 'text-secondary'} text-[18px] font-medium cursor-pointer hover-nav`}
              onClick={() => {
