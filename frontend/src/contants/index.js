...
const projects = [
  ...
  },
  {
    name: "EnhanceAI",
    description:
      "EnhanceAI is a web-based AI-powered tool that improves overall image quality by enhancing resolution, reducing noise, sharpening details, upscaling, and allowing direct downloads in the browser.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
    ...
    image: enhanceAI,
    source_code_link: "https://github.com/ashishkhopde/EnhanceAI",
    live_link: 'https://enhanceai-ai.netlify.app/'
  },
];
